<?php $this->view("catalog/header",$data); ?>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="<?=ASSETS?>catalog/img/Hero-3.jpg" style="height: 600px">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="mb-4 d-flex flex-wrap">
                        ...
                        <div class="mr-4 mb-2">
                            <span class="tm-text-gray-dark">Price: </span><span class="tm-text-primary"><?=$data['image']->price?></span>
                        </div>
                    </div>
                    <div class="mb-4">
