<?php $this->view("catalog/header",$data); ?>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="<?=ASSETS?>catalog/img/Hero.jpg" style="height: 600px">
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <div class="row tm-mb-150 tm-gallery">
