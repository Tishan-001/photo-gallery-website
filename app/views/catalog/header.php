    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link nav-link-1 <?= ($data['page_title']) == "Home" ? 'active':'';?> " aria-current="page" href="<?=ROOT?>index">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-2 <?= ($data['page_title']) == "Gallery" ? 'active':'';?> " href="<?=ROOT?>gallery">Gallery</a>
                </li>
                <li class="nav-item">
