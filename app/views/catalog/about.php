<?php $this->view("catalog/header",$data); ?>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="<?=ASSETS?>catalog/img/Hero-1.jpg" style="height: 600px"></div>

    <div class="container-fluid tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">
            Malcolm Lismore Website 
            </h2>
        </div>
        <div class="row tm-mb-74 tm-row-1640">            
            ...
            <div class="col-lg-7 col-md-6 col-12">
                <div class="tm-about-img-text">
                    <p class="mb-4">
                    Malcolm Lismore is a freelance photographer based on the North West coast of Scotland. His biggest passion in photography is for the natural world. He sells many images of the rugged Scottish landscape, its natural wildlife and coastal birds. However, it’s not just landscape and wildlife photography he is interested in, like many photographers he can also be hired for weddings, portraits, and special events.</p>
                    <p>
                    Malcolm Lismore is a freelance photographer based on the North West coast of Scotland. His biggest passion in photography is for the natural world. He sells many images of the rugged Scottish landscape, its natural wildlife and coastal birds. However, it’s not just landscape and wildlife photography he is interested in, like many photographers he can also be hired for weddings, portraits, and special events.</p>
                </div>                
            </div>
